...
#### 5. CSS中display的默认值是`inline`

#### 6. 定位有哪几种属性？是否占位？相对定位是相对于什么进行定位的？（相对于本身）
...
#### 9. background的默认填充区域有哪些？

border padding content

#### 10. border:none和border:0px有区别吗？
...
#### 18. display：flex和display：box浏览器兼容写法
