...
### 11. window.onload=function(){}和$(document).ready()的区别
...
### 13. JS的执行机制
相关文章：[javascript执行机制](https://www.cnblogs.com/intangible/p/8066979.html)

### 14. 深拷贝与浅拷贝
相关文章：[深拷贝与浅拷贝的区别](https://www.cnblogs.com/echolun/p/7889848.html)
